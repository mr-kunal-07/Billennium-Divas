...
import { useState, ChangeEvent, useCallback, useEffect, useRef, createContext, useContext } from "react";
import { Search, ChevronDown, LogOut, Bell, Menu, X, Home, FileText, HelpCircle, Star, Calendar, User, ChevronLeft, ChevronRight, BarChart3 } from "lucide-react";
    ...
    const navSections: NavSection[] = [
        {
            ...
            items: [
                ...
                { id: 'profile', label: 'My Profile', icon: <User size={18} />, href: '/profile' },
            ],
        },
        {
            title: 'TOOLS',
        ...
        },
        {
            title: 'GENERAL',
            items: [
                { id: 'support', label: 'Support Center', icon: <HelpCircle size={18} />, href: '/support' },
                { id: 'review', label: 'Write A Review', icon: <Star size={18} />, href: '/review' },
                { id: 'meeting', label: 'Book a Meeting', icon: <Calendar size={18} />, href: '/meeting' },
            ],
        },
    ];
        ...
        <>
            ...
            <aside
                className={`
                    ...
                    ${isSidebarOpen ? 'translate-x-0 shadow-2xl w-64' : '-translate-x-full lg:translate-x-0'}
                `}
                ...
                <div className="flex flex-col h-full bg-white">
                    ...
                    <div className="px-6 py-4 border-b border-gray-200 shrink-0">
                        <div className="flex items-center justify-between">
                            {!isCollapsed && (
                                <div className="flex text-xl sm:text-2xl font-semibold items-center gap-2">
