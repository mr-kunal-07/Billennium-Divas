...
import { Search, MessageCircle, ChevronDown, LogOut, Bell } from "lucide-react";
...
export default function AppHeader() {
    ...
    return (
        <header className="sticky top-0 z-50 bg-white  shadow-sm">
            <div className="flex items-center justify-between gap-3 sm:gap-4 px-3 sm:px-6 py-px">
                ...
                <div className="relative flex-1 max-w-md">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-3 sm:pr-14 py-1.5 text-sm rounded-md border border-pink-400 bg-gray-50 focus:ring-1 focus:ring-pink-500 focus:outline-none transition-shadow"
                    />
                </div>
                    ...
                    <div className="relative">
                        ...
                        {isDropdownOpen && (
                            <>
                                ...
                                <div
                                    role="menu"
                                    className="absolute right-0 mt-1 w-56 rounded-md bg-white shadow-md z-50 animate-in fade-in slide-in-from-top-2 duration-200"
                                >
                                    ...
                                    <button
                                        ...
                                        className="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition-colors rounded-md cursor-pointer"
                                    >
                                        <LogOut size={16} />
                                        <span>Logout</span>
                                    </button>
